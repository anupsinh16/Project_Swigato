...
<nav className="navbar navbar-expand-lg fixed-top bg-dark bg-gradient"  id='nav' >
  <div className="container-fluid ">
    <NavLink className="navbar-brand " to="/" style={{color : 'red', fontFamily : 'Fredoka'}}><b></b> </NavLink>
    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span className="navbar-toggler-icon"></span>
    </button>
    <div className="collapse navbar-collapse" id="navbarSupportedContent" >
      <ul className="navbar-nav me-auto mb-2 mb-lg-0 me-2">
        <li style={{color:"red",marginTop:"5px",marginRight:"5px"}}><NavLink to='/'><HomeIcon/></NavLink></li>
